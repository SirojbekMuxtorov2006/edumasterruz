			...
			<div className='max-w-md mx-auto space-y-6'>
				...
				<Card className='border-none shadow-xl overflow-hidden relative'>
					...
					<CardContent className='relative z-10 p-6 text-white'>
						...
						<div className='mt-6 flex justify-between items-end'>
							<div className='text-xs text-indigo-200'>Valid thru: 2026</div>
				...
				<div className='space-y-3'>
					...
					{user.history?.map(item => (
						<Card
							key={item.id}
							className='border-gray-200 hover:border-indigo-300 transition-colors'
						>
									...
									<Dialog>
										...
										<DialogContent className='max-w-lg'>
											...
											<div
												...
												className='border-8 border-double border-indigo-900 p-8 bg-cream min-h-[400px] flex flex-col items-center justify-center text-center space-y-6 relative overflow-hidden bg-[#fffdf5]'
											>
												...
												<div>
													<h2 className='text-4xl font-serif text-indigo-900 font-bold mb-2'>
														Certificate
													</h2>
												...
												<h3 className='text-3xl font-cursive text-indigo-800 my-2 font-bold italic'>
													{user.name}
												</h3>
												<p className='text-gray-600'>
													has successfully completed the <strong>{item.title}</strong>
												</p>
